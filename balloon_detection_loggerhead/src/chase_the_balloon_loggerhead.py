...
Subscribes to
    /loggerhead/balloon/point_balloon
...
class ChaseBalloon():
    def __init__(self):
        ...
        self.sub_center = rospy.Subscriber("/loggerhead/balloon/point_balloon", Point, self.update_balloon)
        rospy.loginfo("Subscribers set")

        self.pub_twist = rospy.Publisher("/loggerhead/cmd_vel", Twist, queue_size=5)
